...
export default function MapPage() {
  ...
  const simulationHandle = useForceLayout(data, 1200, 800, engramId)

  if (loading || !data || !simulationHandle) {
    return (
  ...
  return (
    <div className="w-full h-full relative">
      <EngineGraph data={data} simulationHandle={simulationHandle} engramSlug={engramSlug} />
